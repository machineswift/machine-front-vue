<template>
  ...
  >
    <el-form :model="state.formData" :rules="rules" label-width="100px" ref="formRef">
      ...
      <el-form-item label="品牌LOGO" prop="logoMaterialId" v-hasPermission="['SYSTEM:BASIC_DATA:BRAND:CREATE']">
    ...
    <template #footer>
      ...
      <el-button type="primary" @click="submitForm" :loading="state.submitting" v-hasPermission="['SYSTEM:BASIC_DATA:BRAND:CREATE']">确定</el-button>
    </template>
  </el-dialog>
</template>
