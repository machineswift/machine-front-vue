<template>
  ...
  >
    ...
    <template #footer>
      ...
      <el-button type="primary" @click="handleSubmit" :loading="state.submitting" v-hasPermission="['MANAGE_APP:SYSTEM:BASIC_DATA:AREA:CREATE']">
        确认
      </el-button>
    </template>
  </el-dialog>
...
<script setup lang="ts">
  ...
  import type { DataAreaCreateRequestVo, DataAreaExpandTreeResponseVo } from '@/modules/data/area/type/DataArea.type'

  const props = defineProps<{
    modelValue: boolean
    parentNode: DataAreaExpandTreeResponseVo | null
  }>()
