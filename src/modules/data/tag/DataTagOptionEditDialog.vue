<template>
  ...
  >
    ...
    <template #footer>
      ...
      <el-button type="primary" @click="submitForm" :loading="state.submitting" v-hasPermission="['SYSTEM:BASIC_DATA:TAG_OPTION:UPDATE']">保存</el-button>
    </template>
  </el-dialog>
</template>
...
<script setup lang="ts">
  ...
  import type { DataTagOptionUpdateRequestVo } from '@/modules/data/tag/type/DataTagOption.type'
  ...
  const DEFAULT_FORM_DATA: DataTagOptionUpdateRequestVo = {
    id: '',
    name: '',
    description: ''
  }
  ...
  const submitForm = async () => {
    try {
      ...
      await DataTagOptionApi.update(state.formData)
