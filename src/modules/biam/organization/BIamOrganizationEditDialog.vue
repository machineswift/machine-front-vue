...
<script setup lang="ts">
  ...
  import type { BIamOrganizationUpdateRequestVo } from '@/modules/biam/organization/type/BIamOrganization.type'
  ...
  const state = reactive({
    ...
    formData: {
      ...
      sort: 0,
      description: ''
    } as BIamOrganizationUpdateRequestVo
  })
  ...
  const handleSubmit = async () => {
    try {
      ...
      await BIamOrganizationApi.update(updateData)
