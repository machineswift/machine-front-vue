...
<script setup lang="ts">
  ...
  import LayoutMain from '@/views/admin/layout/main/LayoutMain.vue'
  ...
  const filteredRoutes = computed(() => {
    const rootRoute = userStore.menuRouters.find((route: ExtendedRouteRecordRaw) => route.name === 'ADMIN:LAYOUT')
